        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <Codesandbox className="w-6 h-6 text-red-500" />
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="https://zass.cloud/about" className="text-gray-400 hover:text-red-500 transition-colors">
                  Tentang Kami
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="https://zass.cloud/blob" className="text-gray-400 hover:text-red-500 transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="https://zass.cloud" className="text-gray-400 hover:text-red-500 transition-colors">
                  Karir
                </Link>
              </li>
            </ul>
