...
import { Codesandbox, History, FileText, Home, Users, CodeXml } from "lucide-react"
    ...
    >
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center space-x-2">
          <Codesandbox className={cn("w-8 h-8", scrolled ? "text-red-500" : "text-white")} />
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <NavLink href="https://neolabsofficial.my.id" label="Script bot" scrolled={scrolled} icon={<History className="w-4 h-4 mr-1" />} />
          <NavLink
      ...
      >
        <div className="flex flex-col p-4 space-y-3">
          ...
          />
          <MobileNavLink
            href="https://neolabsofficial.my.id"
            label="Script bot"
            onClick={() => setIsOpen(false)}
